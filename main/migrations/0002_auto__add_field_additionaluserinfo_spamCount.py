...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdditionalUserInfo.spamCount'
        db.add_column(u'main_additionaluserinfo', 'spamCount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdditionalUserInfo.spamCount'
        db.delete_column(u'main_additionaluserinfo', 'spamCount')
