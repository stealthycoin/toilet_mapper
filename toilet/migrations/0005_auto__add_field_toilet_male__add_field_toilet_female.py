...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Toilet.male'
        db.add_column(u'toilet_toilet', 'male',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Toilet.female'
        db.add_column(u'toilet_toilet', 'female',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Toilet.male'
        db.delete_column(u'toilet_toilet', 'male')

        # Deleting field 'Toilet.female'
        db.delete_column(u'toilet_toilet', 'female')
