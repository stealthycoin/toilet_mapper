...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Toilet.numberOfReviews'
        db.add_column(u'toilet_toilet', 'numberOfReviews',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Toilet.rating'
        db.add_column(u'toilet_toilet', 'rating',
                      self.gf('django.db.models.fields.DecimalField')(default=5.0, max_digits=11, decimal_places=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Toilet.numberOfReviews'
        db.delete_column(u'toilet_toilet', 'numberOfReviews')

        # Deleting field 'Toilet.rating'
        db.delete_column(u'toilet_toilet', 'rating')
